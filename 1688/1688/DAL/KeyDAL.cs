...
namespace DAL
{
    ...
    public class KeyDAL
    {
        ...
        public static Queue<KeyEntity> GetList()
        {
            ...
            //list.Enqueue(new KeyEntity() { Name = "测试企业对接跨境22", AppKey = "5344570", SecretKey = "gK2GorRtxA", ApiCount = 5000 });

            list.Enqueue(new KeyEntity() { Name = "店铺装修009", AppKey = "9718829", SecretKey = "F7xkjZSJOl", ApiCount = 5000 });
            list.Enqueue(new KeyEntity() { Name = "测试企业对接跨境", AppKey = "2812368", SecretKey = "H0tosi7c9v", ApiCount = 5000 });
            list.Enqueue(new KeyEntity() { Name = "店铺复制产品", AppKey = "7149237", SecretKey = "CFjjYrvhY27", ApiCount = 5000 });
